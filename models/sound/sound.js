...
SoundSchema.pre("save", async function (next) {
...
// JWT TOKEN
SoundSchema.methods.getJwtToken = function () {
...
SoundSchema.methods.generatePasswordResetToken = function () {
  // Generating token
  const resetToken = crypto.randomBytes(20).toString("hex");
  // Hashing and add to SoundSchema
